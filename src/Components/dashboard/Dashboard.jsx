  ...
  return (
    <div className='dash flex flex-col gap-[40px]'>
      ...
      <div className='flex gap-[20px] '>
        <div className='w-[100%] h-[200px] bg-[#00A551] rounded-[30px] text-[#FFFF] flex flex-col justify-center items-center'>
          <p className='text-[36px]'>168</p>
          <p>Services Requested</p>
        </div>
        <div className='w-[100%] h-[200px] bg-[#F7C35F] rounded-[30px] text-[#FFFF] flex flex-col justify-center items-center'>
          <p className='text-[36px]'>128</p>
          <p>Services In Progress</p>
        </div>
        <div className='w-[100%] h-[200px] bg-[#E51C26] rounded-[30px] text-[#FFFF] flex flex-col justify-center items-center'>
          <p className='text-[36px]'>40</p>
          <p>Services Incomplete</p>
        </div>
        <div className='w-[100%] h-[200px] bg-[black] rounded-[30px] text-[#FFFF] flex flex-col justify-center items-center'>
